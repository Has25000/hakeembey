...
import imageOfMe from '../../assets/imageofme.jpg';
import meAtTanium from '../../assets/me_at_tanium.jpg';
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        ...
        >
          <img
            ...
            className="w-28 h-36 md:w-32 md:h-40 rounded-xl object-cover border-2 border-border shadow-lg"
          />
          <img
            src={meAtTanium}
            alt="Hakeem at Tanium"
            className="w-28 h-36 md:w-32 md:h-40 rounded-xl object-cover border-2 border-border shadow-lg"
          />
        </motion.div>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed">
                ...
                concept to reality, teaching me how to build ventures, not just technology. Together, these prepare me to create
