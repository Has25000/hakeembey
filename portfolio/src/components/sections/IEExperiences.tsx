...
const experiences: Experience[] = [
  {
    ...
    description: {
      ...
      whyChosen: 'I chose this experience because I wanted to understand what it truly takes to build a product from zero to one. I had technical skills but lacked experience in the messy reality of startup execution—dealing with ambiguity, shipping fast, and learning from real users. Resonate gave me the opportunity to wear multiple hats and experience the full lifecycle of early-stage venture building.',
    },
    reflection: {
